...
//Referencias
const emailbox = document.getElementById("correo");
...
function insertData(){
    ...
    const namebox = document.getElementById("nombre");
    const passwordbox = document.getElementById("password");
    const repeatPasswordbox = document.getElementById("password2");
    
    const telefonobox = document.getElementById("telefono");
    ...
    registerUser.set({
        User: userbox.value,
        Nombre: namebox.value,
        Password: passwordbox.value,
        Confirm_Password: repeatPasswordbox.value,
        Correo: emailbox.value,
        Telefono: telefonobox.value,
        Rol: rolbox.value
    })
